    ...
    <div className="pt-[66px] min-h-screen pb-20">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mb-10 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="text-xs font-mono-tech" style={{ color: "var(--text-muted)" }}>
            Showing {filteredIndustries.length} of {industriesData.length} Sectors
          </div>
        </div>

        <div className="grid lg:grid-cols-12 gap-8 items-start">
          {/* Left Industry Selector List (5 Cols) */}
            ...
            {filteredIndustries.map((ind) => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left p-4 rounded-2xl transition-all cursor-pointer border flex items-center gap-4 group"
                  style={{
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 right-6">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      >
                        <SelectedIcon size={20} color={selected.color} />
                      </div>
                      <span className="text-xs font-mono-tech uppercase tracking-wider text-white opacity-80">
                        Sector Detail Preview
                      </span>
                    </div>
                ...
                <div className="p-8">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
                    {selected.stats.map((s) => (
                      <div key={s.label} className="p-3 rounded-xl text-center" style={{ background: "var(--surface)", border: "1px solid var(--card-border)" }}>
                        <div className="font-display font-black text-xl mb-0.5" style={{ color: selected.color }}>
                          {s.value}
                        </div>
                        <div className="text-[0.68rem] font-medium" style={{ color: "var(--text-muted)" }}>
                          {s.label}
                        </div>
                      </div>
                    ))}
                  ...
                  {/* Solutions Provided */}
                  <div className="mb-8">
                    <h4 className="font-display font-bold text-xs uppercase tracking-wider mb-4" style={{ color: "var(--text-muted)" }}>
                    ...
                    <div className="space-y-3">
                      {selected.solutionsProvided.map((sol) => {
                        ...
                        return (
                          ...
                          >
                            <div className="p-2 rounded-lg mt-0.5" style={{ background: `color-mix(in srgb, ${selected.color} 10%, transparent)` }}>
                  ...
                  {/* Actions */}
                  <div className="flex flex-wrap gap-4 pt-4 border-t" style={{ borderColor: "var(--card-border)" }}>
                    <button
            ...
            {industriesData.map((ind) => {
              ...
              return (
                <button
                  ...
                  className="card p-5 text-center cursor-pointer group hover:scale-105 transition-all flex flex-col items-center justify-center border"
